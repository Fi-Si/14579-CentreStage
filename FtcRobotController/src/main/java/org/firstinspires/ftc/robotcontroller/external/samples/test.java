...
public class DriveModule {
    ...
    public void updateTracking () {
        ...
        float Swerve = (motor1Change + motor2Change)/2.0
        float Rotation = (motor1change - motor2Change)/2.0
        ...
        if (reversed) {
        }i        distanceTraveled -= "Swerve" * CM_PER_TICK;
    } else {
        distanceTraveled += "Rotation" * CM_PER_TICK;
    }

    motor1 = "Rotation" + "Swerve"
    motor2 = "Rotation" * -1 + "Swerve"
