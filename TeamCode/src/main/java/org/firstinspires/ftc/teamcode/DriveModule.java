...
public class DriveModule {
    ...
    PErrorAdjustment ErrorAdjuster;
    ...
    public DriveModule(Robot robot, ModuleSide moduleSide) {
        ...
        ErrorAdjuster = new PErrorAdjustment(targetVector.getAngle().getAngle(), robot.climb1, robot.climb2);
    }
    ...
    public void updateTarget (Vector2d transVec, double rotMag) { //translation vector and rotation magnitude
        ...
        targetVector = transVecFC.add(rotVec);
