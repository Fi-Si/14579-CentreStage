...
@TeleOp(name = "CenterstageTeleOpUpdatedEncoders)")
class CenterstageTeleOpUpdatedEncoders extends LinearOpMode {
    ...
    private void LiftAndDiffLoop() {
        ...
        IsRightTriggerPressed = gamepad2.right_trigger > 0.1;
        ...
        if (Lift1.getCurrentPosition() > -70) {
            Diff2.setPosition(Diff2Rest);
            Diff1.setPosition(Diff1Rest);
        } else if (Lift1.getCurrentPosition() < -70 && Lift1.getCurrentPosition() > -350 || IsRightTriggerPressed) {
